"""Cut-in events from the pre-computed `cutin_events` table."""
...
def _format_row(r):
    ...
    return {
        ...
        "objects": [{"token": token, "category": "vehicle", "label": "cut-in"}],
        "summary": f"{who} cut-in f{r['start_frame']}-{r['end_frame']}",
    }
